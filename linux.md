...
- iostat
```
iostat -xk 1 100 显示所有设备的详细的 I/O 统计信息
iostat -d 查看所有设备的 I/O 统计

Linux 3.10.0-514.el7.x86_64 (hadoop011-security-datanode09)     09/06/2022      _x86_64_        (16 CPU)

avg-cpu:  %user   %nice %system %iowait  %steal   %idle
           9.55    0.00    3.88    0.01    0.00   86.56

Device:         rrqm/s   wrqm/s     r/s     w/s    rkB/s    wkB/s avgrq-sz avgqu-sz   await r_await w_await  svctm  %util
sda               0.00     1.20    0.17   33.51    12.66   731.81    44.22     0.04    1.10    5.60    1.08   0.06   0.21
sdb               0.00     0.01    0.08    0.10     2.98    11.79   168.14     0.00   15.14    4.43   23.30   0.38   0.01
sdc               0.00     0.00    0.03    0.04     3.73     8.48   355.93     0.00   12.28    6.43   15.69   0.54   0.00
sde               0.00     0.00    0.00    0.03     0.97     7.56   485.89     0.00   17.66   23.00   16.87   0.43   0.00
sdd               0.00     0.00    0.04    0.09     7.62    22.82   467.42     0.01   72.17    7.99   96.03   0.93   0.01
sdf               0.00     0.00    0.00    0.03     0.91     7.17   484.17     0.00    8.04   22.78    5.82   0.38   0.00
sdg               0.00     0.00    0.00    0.03     1.00     7.03   483.51     0.00    8.14   22.34    5.77   0.40   0.00
sdh               0.00     0.00    0.00    0.03     0.95     7.13   484.66     0.00    7.82   21.43    5.71   0.38   0.00
sdi               0.00     0.00    0.00    0.03     0.91     7.16   486.39     0.00    8.02   23.48    5.77   0.38   0.00
sdj               0.00     0.00    0.00    0.03     1.01     7.09   485.68     0.00    7.82   19.97    5.83   0.39   0.00
sdk               0.00     0.01    0.02    0.09     3.04     8.90   204.93     0.00    8.20    6.62    8.62   0.23   0.00
sdl               0.00     0.00    0.00    0.03     0.97     7.11   484.52     0.00    7.75   19.50    5.86   0.39   0.00
sdm               0.00     0.00    0.00    0.03     0.94     7.08   486.77     0.00    7.84   21.23    5.84   0.39   0.00
sdn               0.00     0.00    0.00    0.03     1.07     7.09   484.23     0.00    8.00   21.43    5.68   0.40   0.00
sdo               0.00     0.00    0.00    0.03     1.02     7.13   484.22     0.00    7.99   21.28    5.77   0.39   0.00
sdp               0.00     0.00    0.05    0.08    13.31    19.48   504.65     0.01  104.94    7.09  171.61   1.48   0.02
sdq               0.00     0.00    0.01    0.03     1.21     7.61   447.34     0.00   12.54   11.82   12.73   0.46   0.0
...
- lsof
```
lsof -p <pid> 展示进程打开的所有文件
```
- strace
```
strace -p pid 查看进程当前调用栈，查死循环或者卡顿时极为有用
strace -eopen {文件路径}  查看进程当前打开了哪些文件

启动要跟踪的进程
strace ls -lh /var/log/messages
跟踪运行中的进程
strace -tt -T -v -f -e trace=file -o strace.log -s 1024 -p 123
...
- pstack
```
ps -eLf|grep {pid} 或 ps -T -p {pid} 或 pstree -p {pid}
pstack {线程ID}
```
- linux rm 设备或资源忙
```
