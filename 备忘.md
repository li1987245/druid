...
B/S
2、数据敏感性
https加密传输、敏感数据加密存储/脱敏显示
数据权限支持分级授权控制
3、用户权限和访问控制
功能采用RBAC模型进行权限控制，粒度到按钮级别
数据权限支持分级授权控制
4、系统安全性
身份鉴别、访问控制、加密传输、安全审计、文件透明加密
5、系统性能
模型训练：10万*1000特征样本耗时3-5分钟
6、系统部署架构
7、数仓、风控对接
8、模型平台数据流向
...
工商、税收、金融、交通、财政、审计、教育、人口、公共安全、交易机构、海关、招聘、知识产权


爱分析 艾瑞


AUC是分类模型通用评价指标   KS是针对不平衡（好坏分类占比差别大）分类评价指标