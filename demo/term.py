...
if __name__ == '__main__':
    ...
    parse.add_option("-u", "--username", action = "store",type="string",dest = "username", default="eddy245")
    parse.add_option("-p", "--password", action = "store",type="string",dest = "password", default="lovedan&123")
